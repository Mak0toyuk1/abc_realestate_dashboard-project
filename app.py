...
st.title("ABC Real Estate Dashboard")

st.write(
    """
    This dashboard provides rental and school-related analysis for ABC Real Estate Corporation.
...
st.markdown(
    """
    - **Rental Trends**: Monthly average rent trends by building group, building, bedroom number, postal code, and rental year.
    - **School Overview**: School scores, rankings, and school details by building group.
    - **Top and Bottom Rents**: Highest and lowest rent units by selected filters.
    - **Vacancy Analysis**: Vacancy-rate and unrented-day analysis.
    - **Yearly Rent Overview**: Average rent comparison across 2024, 2025, and 2026.
    """
)